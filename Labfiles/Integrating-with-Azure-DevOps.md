...
4. In the **Create a project to get started**, enter the Project name as **Azure DevOps** **(1)**, Select **Public** **(2)** as visibility and click on **+ Create project** **(3)**.
...
6. In the Azure DevOps page click on the **User settings** **(1)** from the top right corner of the page and click on **Preview features** **(2)**.
...
7. In the **Preview features** pop-up, ensure to set the toggle button to **off** for **New Boards Hubs** **(1)** and close the preview features by clicking on **X** **(2)**.
   
   ![](../media/new-boards-hubs1.png)

8. In your browser open GitHub Marketplace by navigating to the below URL:
...
9. Scroll to the bottom of the page and select `Install it for Free.`

   ![](../media/2dg50.png)

    >**Note:** If the **Install it for free** button is greyed out, please proceed to next step.

10. Please enter the billing details :
...
10. On the next page, select **Complete order and begin installation**.

11. Select the lab files repository `github-action` which you created earlier and click on **Install & Authorize**.
...
11. Select Azure DevOps organization and select the **Azure DevOps** **(2)** project then click on **Continue (3)**
...
11. In the Azure Boards tab, click on **New Item** **(1)**, provide **Test DevOps Action** **(2)** as a description and create a new work item by hitting **enter**.

     ![](../media/ex4-task2-step1.png)
   
12. After creating a work item, Please note down the Work item ID which will be used in the further steps.

     ![](../media/ex4-kc-todo-new1.png)
   
13. Select the **Code** **(1)** tab in your GitHub repository, navigate to **.github/workflows/** **(2)** and select **any of the workflow you crated** **(3)** file.

     ![](../media/2dgn140.png)
   
14. In the workflow file click on **edit** button.

     ![](../media/edit.png)

15. Copy `#test azure boards` code and paste it into line number 1 of the file. Make sure there are no indentation errors.

     ![](../media/2dgn166.png)
   
16. Click on **Commit Changes** ***(1)***, provide the details mentioned below and click on **Propose changes** ***(5)***.
...
17. On Open a pull request tab, Click on **Create pull request** 

     ![](../media/ex4-create-pr.png)
   
18. Navigate to **Azure Boards**. Open the **work item** ***(1)*** created in the earlier step.
